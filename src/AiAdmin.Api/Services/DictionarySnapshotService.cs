    ...
    , ILogger<DictionarySnapshotService> logger)
{
    ...
    ///     计划作业占位符目录编码
    /// </summary>
    public const string ScheduledJobPlaceholdersCode = "scheduled_job_placeholders";

    /// <summary>
    ///     系统设置目录编码
    /// </summary>
    public const string SystemSettingsCode = "system_settings";
    ...
    public static bool IsSupported(string categoryCode)
    {
        return categoryCode is SystemSettingsCode or ScheduledJobPlaceholdersCode;
    }
