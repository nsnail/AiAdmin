...
#pragma warning disable CS1591, SA1516, SA1514, SA1642, SA1513, SA1518, IDE0022, IDE0058, IDE0011, SA1503, S6580, CA1305
...
{
    /// <summary>MinIO 访问密钥</summary>
    public string AccessKey { get; set; } = string.Empty;

    /// <summary>MinIO 存储桶名称</summary>
    public string Bucket { get; set; } = "aiadmin";

    /// <summary>MinIO 服务地址</summary>
    public string Endpoint { get; set; } = "localhost:9000";

    /// <summary>对象预览域名</summary>
    public string PublicUrl { get; set; } = string.Empty;

    /// <summary>MinIO 私密密钥</summary>
