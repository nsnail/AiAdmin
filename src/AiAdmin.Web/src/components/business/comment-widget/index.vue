<template>
    <div>
        <ElForm @submit.prevent="addComment" class="w-full mx-auto mb-10">
            <ElFormItem class="mt-5" prop="author">
                <ElInput v-model="newComment.author" class="block w-full" clearable placeholder="你的名称" />
            </ElFormItem>
            <ElFormItem prop="content">
                <ElInput v-model="newComment.content" :rows="5" clearable placeholder="简单说两句..." type="textarea" />
            </ElFormItem>
            <ElFormItem>
                <div class="flex justify-end w-full">
                    <ElButton @click="addComment" type="primary"> 发布 </ElButton>
                </div>
            </ElFormItem>
        </ElForm>
