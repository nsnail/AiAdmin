    ...
    <div class="art-card p-5">
        ...
        <ElScrollbar :style="{ height: maxHeight }">
            <div v-for="(item, index) in list" :key="index" class="flex-c py-3">
                <div v-if="item.icon" :class="item.class" class="flex-cc mr-3 size-10 rounded-lg">
        ...
        <ElButton v-if="showMoreButton" v-ripple @click="handleMore" class="mt-[25px] w-full text-center">查看更多</ElButton>
    </div>
</template>
