<!-- 环型图卡片 -->
<template>
    <div :style="{ height: `${height}rem` }" class="art-card overflow-hidden">
            ...
            <div class="flex w-full items-start gap-5">
                <div class="flex-b h-full flex-1 flex-col">
                    ...
                    <div>
                        ...
                        <div :class="percentage > 0 ? 'text-success' : 'text-danger'" class="mt-1.5 text-xs font-medium">
                ...
                <div class="flex-c h-full max-w-40 flex-1">
                    <div class="h-30 w-full" ref="chartRef"></div>
                </div>
            </div>
        </div>
    </div>
