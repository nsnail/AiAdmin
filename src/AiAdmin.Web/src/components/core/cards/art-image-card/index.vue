<!-- 图片卡片 -->
<template>
    <div @click="handleClick" class="w-full c-p">
        <div class="art-card overflow-hidden">
            <div class="relative w-full aspect-[16/10] overflow-hidden">
                ...
                <div v-if="props.readTime" class="absolute right-3.5 bottom-3.5 py-1 px-2 text-xs bg-g-200 rounded">{{ props.readTime }} 阅读</div>
            </div>

            <div class="p-4">
                <div v-if="props.category" class="inline-block py-0.5 px-2 mb-2 text-xs bg-g-300/70 rounded">
                    {{ props.category }}
                </div>
