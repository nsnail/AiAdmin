<!-- 折线图卡片 -->
<template>
    <div :style="{ height: `${height}rem` }" class="art-card relative overflow-hidden">
        <div class="mb-2.5 flex-b items-start p-5">
            ...
            <div :class="[percentage > 0 ? 'text-success' : 'text-danger', isMiniChart ? 'absolute bottom-5' : '']" class="text-sm font-medium">
                    ...
                    areaStyle: props.showAreaColor
                        ? {
                              color: new graphic.LinearGradient(0, 0, 0, 1, [
                                  ...
                                  {
                                      offset: 1,
                                      color: props.color ? hexToRgba(props.color, 0.01).rgba : hexToRgba(getCssVar('--el-color-primary'), 0.01).rgba,
                                  },
                              ]),
                          }
                        : undefined,
