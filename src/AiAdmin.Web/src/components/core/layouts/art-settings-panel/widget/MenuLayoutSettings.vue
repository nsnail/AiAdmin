<template>
    <div v-if="width > 1000">
        ...
        <div class="setting-box-wrap">
            <div v-for="(item, index) in configOptions.menuLayoutList" :key="item.value" @click="switchMenuLayouts(item.value)" class="setting-item">
                <div :class="{ 'is-active': item.value === menuType, 'mt-16': index > 2 }" class="box">
                    <img :src="item.img" />
                </div>
