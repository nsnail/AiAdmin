<template>
    <div :class="{ 'mobile-hide': config.mobileHide }" class="flex-cb mb-4 last:mb-2">
        ...
        <!-- 选择器类型 -->
        <ElSelect v-else-if="config.type === 'select'" :model-value="modelValue" :style="config.style" @change="handleChange" filterable>
