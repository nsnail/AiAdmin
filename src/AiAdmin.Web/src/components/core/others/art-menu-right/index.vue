...
<template>
    <div class="menu-right">
        <Transition @after-leave="onAfterLeave" @before-enter="onBeforeEnter" name="context-menu">
            <div v-show="visible" :style="menuStyle" class="context-menu art-card-xs !shadow-xl min-w-[var(--menu-width)] w-[var(--menu-width)]">
                <ul :style="menuListStyle" class="menu-list m-0 list-none">
                    <template v-for="item in menuItems" :key="item.key">
                        ...
                        <li
                            ...
                            <ArtSvgIcon v-if="item.icon" :icon="item.icon" class="mr-2 shrink-0 text-base text-g-800" />
                        ...
                        <li
                            ...
                            <ul
                                ...
                                <li
                                    ...
                                    <ArtSvgIcon v-if="child.icon" :icon="child.icon" class="r-2 shrink-0 text-base text-g-800 mr-1" />
