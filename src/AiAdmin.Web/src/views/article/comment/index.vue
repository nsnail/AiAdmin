...
<template>
    <div>
        ...
        <ul class="mt-10 grid grid-cols-5 gap-5 max-2xl:grid-cols-4 max-xl:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 mb-5">
            <li
                ...
                <div class="absolute bottom-4 left-0 px-4 flex-cb w-full">
                    <div class="flex-c">
                        <div class="flex-c mr-5 text-xs text-g-600">
                            <ArtSvgIcon class="mr-1 text-base" icon="ri:heart-line" />
                            <span>{{ item.collection }}</span>
                        </div>
                        <div class="flex-c mr-5 text-xs text-g-600">
                            <ArtSvgIcon class="mr-1 text-base" icon="ri:message-3-line" />
        ...
        <ElDrawer v-model="showDrawer" :lock-scroll="false" :size="360" lDrawer modal-class="comment-modal">
            <template #header>
                <h4>详情</h4>
            </template>
            <template #default>
                <div class="drawer-default">
                    <div :style="{ background: clickItem.color }" class="relative p-4 aspect-16/12">
