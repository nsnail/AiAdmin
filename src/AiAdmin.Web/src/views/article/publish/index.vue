    ...
    <div>
        <div>
            <div class="max-w-250 mx-auto my-5">
                ...
                <ElRow :gutter="10">
                    <ElCol :span="18">
                        <ElInput v-model.trim="articleName" maxlength="100" placeholder="请输入文章标题（最多100个字符）" />
                    </ElCol>
                    <ElCol :span="6">
                        <ElSelect v-model="articleType" filterable placeholder="请选择文章类型">
                ...
                <!-- 富文本编辑器 -->
                <ArtWangEditor v-model="editorHtml" class="mt-2.5" />
                ...
                <div class="p-5 mt-5 art-card-xs">
                        ...
                        <ElFormItem label="封面">
                            <div class="mt-2.5">
                                <ElUpload
                                    ...
                                    <div v-if="!cover" class="flex-cc flex-col w-65 h-40 border border-dashed border-[#d9d9d9] rounded-md">
                    ...
                    <div class="flex justify-end">
                        <ElButton @click="submit" class="w-25" type="primary">
