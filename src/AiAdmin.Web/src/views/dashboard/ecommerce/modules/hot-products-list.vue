<template>
    <div class="art-card p-5 h-[27.8rem] mb-5 overflow-hidden max-sm:mb-4">
        ...
        <ElScrollbar class="w-full" style="height: 21.55rem">
            <ArtTable
                :border="false"
                :data="tableData"
                ...
                <template #default>
                    <ElTableColumn label="产品" prop="product" width="220px">
                        <template #default="scope">
                            <div class="flex-c">
                                <img :src="scope.row.image" class="size-12.5 object-cover rounded-md" />
                    ...
                    <ElTableColumn label="库存" prop="stock">
                        <template #default="scope">
                            <div :class="getStockClass(scope.row.stock)" class="inline-block px-2 py-1 text-xs font-medium rounded">
                    ...
                    <ElTableColumn label="销售趋势" width="240">
                        <template #default="scope">
                            <ElProgress :color="scope.row.color" :percentage="scope.row.pro" :stroke-width="4" />
                        </template>
                    </ElTableColumn>
                </template>
            </ArtTable>
