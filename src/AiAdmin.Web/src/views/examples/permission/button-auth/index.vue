    ...
    <div class="w-full py-2">
                ...
                <div>
                    ...
                    <div class="flex items-start mb-4 last:mb-0">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <ElTag v-for="permission in currentUserPermissions" :key="permission" class="m-0" size="small" type="info">
                                {{ permission }}
                            </ElTag>
                            <span v-if="!currentUserPermissions.length" class="italic text-red-500">无权限码</span>
                        </div>
                    </div>
                </div>
            </ElCard>
            ...
            <ElCard class="art-card-xs">
                ...
                <div>
                    <p class="p-3 m-0 mb-5 text-sm leading-[1.6] text-g-700 bg-g-200 rounded">
                        使用
                        <code class="px- 1.5 py-0.5 font-mono text-xs text-theme bg-theme/10 rounded">v-roles</code>
                        指令控制按钮显示，只有拥有指定角色的用户才能看到对应按钮。
                    </p>

                    <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-5">
                        <div class="flex flex-col gap-2">
                            <ElButton v-roles="'R_SUPER'" plain type="primary"> 超级管理员可见 </ElButton>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-roles="'R_SUPER'"</code>
                        ...
                        <!-- 管理员级别按钮 -->
                        <div class="flex flex-col gap-2">
                            <ElButton v-roles="['R_SUPER', 'R_ADMIN']" plain type="warning"> 管理员可见 </ElButton>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-roles="['R_SUPER', 'R_ADMIN']"</code>
                        ...
                        <!-- 所有已登录用户可见 -->
                        <div class="flex flex-col gap-2">
                            <ElButton v-roles="['R_SUPER', 'R_ADMIN', 'R_USER']" plain type="success"> 所有用户可见 </ElButton>
                            <div class="text-xs">
            ...
            <ElCard class="art-card-xs">
                <template #header>
                    <div class="flex-cb font-semibold">
                        ...
                        <ElTag v-if="!isFrontendMode" size="small" type="success">当前模式</ElTag>
                        <ElTag v-else size="small" type="info">非当前模式</ElTag>
                    </div>
                </template>
                <div>
                    <p class="p-3 m-0 mb-5 text-sm leading-[1.6] text-g-700 bg-g-200 rounded">
                        <code class="px- 1.5 py-0.5 font-mono text-xs text-theme bg-theme/10 rounded">v-auth</code>
                        指令在后端模式下根据当前路由的
                        <code class="px- 1.5 py-0.5 font-mono text-xs text-theme bg-theme/10 rounded">meta.authList</code>
                        配置检查权限。 权限列表来源于路由元数据，适用于权限配置由后端统一管理的场景。
                    </p>

                    <div class="mb-5">
                        <h4 class="m-0 mb-2 text-sm font-semibold">当前路由权限配置：</h4>
                        <div class="max-h-30 p-3 overflow-y-auto font-mono text-xs break-all whitespace-pre-wrap bg-g-200 border-full-d rounded">
                    ...
                    <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-5">
                        <!-- 新增权限 -->
                        <div class="flex flex-col gap-2">
                            <ElButton v-auth="'add'" plain type="primary"> 新增 </ElButton>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-auth="'add'"</code>
                        ...
                        <!-- 编辑权限 -->
                        <div class="flex flex-col gap-2">
                            <ElButton v-auth="'edit'" plain type="warning"> 编辑 </ElButton>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-auth="'edit'"</code>
                        ...
                        <!-- 删除权限 -->
                        <div class="flex flex-col gap-2">
                            <ElButton v-auth="'delete'" plain type="danger"> 删除 </ElButton>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-auth="'delete'"</code>
                        ...
                        <!-- 导出权限 -->
                        <div class="flex flex-col gap-2">
                            <ElButton v-auth="'export'" plain type="info"> 导出 </ElButton>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-auth="'export'"</code>
        ...
        <div class="mb-6 last:mb-0">
            <ElCard class="art-card-xs">
                ...
                <div>
                    <p class="p-3 m-0 mb-5 text-sm leading-[1.6] text-g-700 bg-g-200 rounded">
                        <code class="px- 1.5 py-0.5 font-mono text-xs text-theme bg-theme/10 rounded">hasAuth</code>
                        方法在前端模式下根据用户信息中的
                        <code class="px- 1.5 py-0.5 font-mono text-xs text-theme bg-theme/10 rounded">buttons</code>
                    ...
                    <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <ElButton v-else disabled type="info"> 无查看权限 </ElButton>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-if="hasAuth('view')"</code>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">:disabled="!hasAuth('publish')"</code>
                        ...
                        <!-- 批量操作按钮 -->
                        <div class="flex flex-col gap-2">
                            <ElDropdown :disabled="!hasBatchPermissions" @command="handleBatchAction">
                                ...
                                <template #dropdown>
                                    <ElDropdownMenu>
                                        <ElDropdownItem :disabled="!hasAuth('edit')" command="batchEdit"> 批量编辑 </ElDropdownItem>
                                        <ElDropdownItem :disabled="!hasAuth('delete')" command="batchDelete"> 批量删除 </ElDropdownItem>
                                        <ElDropdownItem :disabled="!hasAuth('export')" command="batchExport"> 批量导出 </ElDropdownItem>
                                    </ElDropdownMenu>
                                </template>
                            </ElDropdown>
                            <div class="text-xs">
                    ...
                    <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            <ElSwitch
                                ...
                                inactive-text="功能关闭" />
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">:disabled="!hasAuth('config')"</code>
                        ...
                        <div class="flex flex-col gap-2">
                            <div v-if="hasAuth('manage')" class="flex gap-2 p-3 bg-g-200 border-full-d rounded">
                                <ElButton size="small" type="primary">管理操作</ElButton>
                                <ElButton size="small" type="warning">高级设置</ElButton>
                            </div>
                            <div v-else class="flex-c gap-2 p-3 text-g-500 bg-g-200 border border-dashed border-g-400 rounded">
                                <ElIcon><Lock /></ElIcon>
                                <span class="text-sm">需要管理权限才能查看此区域</span>
                            </div>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-if="hasAuth('manage')"</code>
                        ...
                        <div class="flex flex-col gap-2">
                            <div class="flex flex-wrap gap-3">
                                <ElBadge :type="hasAuth('add') ? 'success' : 'danger'" :value="hasAuth('add') ? '✓' : '✗'">
                                    <ElButton size="small">新增权限</ElButton>
                                </ElBadge>
                                <ElBadge :type="hasAuth('edit') ? 'success' : 'danger'" :value="hasAuth('edit') ? '✓' : '✗'">
                                    <ElButton size="small">编辑权限</ElButton>
                                </ElBadge>
                                <ElBadge :type="hasAuth('delete') ? 'success' : 'danger'" :value="hasAuth('delete') ? '✓' : '✗'">
                                    <ElButton size="small">删除权限</ElButton>
                                </ElBadge>
                            </div>
                            <div class="text-xs">
                                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">hasAuth('permission')</code>
                ...
                <div>
                    <div class="mt-4">
                        <ElTable :data="comparisonData" border>
                            <ElTableColumn label="功能特性" prop="feature" width="150" />
                            <ElTableColumn label="前端模式" prop="frontend" />
                            <ElTableColumn label="后端模式" prop="backend" />
                        </ElTable>
                    </div>
                </div>
            </ElCard>
