    ...
    <div class="page-content">
        ...
        <ElCard class="mb-7.5" header="修改标签标题">
            <div class="flex gap-2">
                <ElInput v-model="newTabTitle" class="!max-w-75" clearable placeholder="请输入新的标签页标题" />

                <ElButton :disabled="!newTabTitle.trim()" @click="handleUpdateTabTitle" type="primary"> 修改 </ElButton>
        ...
        <ElCard class="mb-7.5" header="获取标签页信息">
            ...
            <ElRow :gutter="20">
                <ElCol :span="24">
                    <ElButton @click="handleGetCurrentTabTitle(routePath)" plain type="success"> 获取当前标签页信息 </ElButton>
                </ElCol>
            </ElRow>
        </ElCard>
        ...
        <ElCard class="mb-7.5" header="关闭标签页">
            <ElRow :gutter="20">
                <ElCol :span="24">
                    <ElButton @click="handleCloseTab(routePath)" plain type="danger"> 关闭当前标签 </ElButton>
                    <ElButton @click="handleCloseOthersTab(routePath)" plain type="warning"> 关闭其他标签 </ElButton>
                    <ElButton @click="handleCloseAllTab" plain type="danger"> 关闭所有标签 </ElButton>
                </ElCol>
            </ElRow>
        </ElCard>
    </div>
