<template>
    <div class="pt-5">
        ...
        <ElRow :gutter="20">
            <ElCol :md="12" :sm="12" :xs="24" class="mb-5">
                <ArtBasicBanner subtitle="系统访问量同比增长 23%，所有服务运行稳定，数据监控正常。" title="数据中心运行状态" />
            </ElCol>
            <ElCol :md="12" :sm="12" :xs="24" class="mb-5">
                <ArtBasicBanner
                    :buttonConfig="{
        ...
        <ElRow :gutter="20">
            ...
            <ElCol :md="12" :sm="12" :xs="24" class="mb-5">
                <ArtBasicBanner
                    ...
                    <template #button>
                        <div style="margin-top: 12px">
                            <ElButton color="#04A1FF" type="primary"> 查看文档 </ElButton>
                        </div>
                    </template>
                </ArtBasicBanner>
            </ElCol>
        ...
        <ElRow :gutter="20">
            <ElCol :lg="6" :md="12" :sm="12" :xs="24" class="mb-5">
                <ArtCardBanner description="所有核心服务运行稳定，响应时间在正常范围内。" title="系统运行正常" />
            </ElCol>
            <ElCol :lg="6" :md="12" :sm="12" :xs="24" class="mb-5">
                <ArtCardBanner
                    :button="{
