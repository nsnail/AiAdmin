<template>
    <div class="page-content mb-5">
            ...
            <template #date-cell="{ data }">
                <div
                    ...
                    <div class="flex flex-col gap-1 w-full max-h-21 pr-1 mt-6 overflow-y-auto">
                        <div v-for="event in getEvents(data.day)" :key="`${event.date}-${event.content}`" @click.stop="handleEventClick(event)">
                            <div
        ...
        <!-- 事件编辑弹窗 -->
        <ElDialog v-model="dialogVisible" :title="dialogTitle" @closed="resetForm" width="600px">
            ...
            <template #footer>
                <span class="dialog-footer">
                    <ElButton v-if="isEditing" @click="handleDeleteEvent" type="danger"> 删除 </ElButton>
                    <ElButton @click="handleSaveEvent" type="primary">
                        {{ isEditing ? '更新' : '添加' }}
                    </ElButton>
                </span>
            </template>
