...
<template>
    <div class="pt-5">
        ...
        <ElRow :gutter="20">
            <ElCol :lg="8" :md="12" :xs="24" class="mb-5">
                <div class="art-card">
                    <div class="pb-3.5">
                        <span class="text-base font-medium">柱状图（单数据）</span>
                    </div>
                    <ArtBarChart :data="singleBarData" :showLegend="true" :xAxisData="xAxisData" legendPosition="right" />
                </div>
            </ElCol>
            <ElCol :lg="8" :md="12" :xs="24" class="mb-5">
                <div class="art-card">
                    ...
                    <ArtBarChart :data="multiBarData" :showLegend="true" :xAxisData="xAxisData" barWidth="26%" />
                </div>
            </ElCol>
            <ElCol :lg="8" :md="12" :xs="24" class="mb-5">
                <div class="art-card">
                    ...
                    <ArtBarChart :data="stackBarData" :showLegend="true" :stack="true" :xAxisData="stackXAxisData" barWidth="26%" />
                </div>
            </ElCol>
            <ElCol :lg="8" :md="12" :xs="24" class="mb-5">
                <div class="art-card">
            ...
            <ElCol :lg="8" :md="12" :xs="24" class="mb-5">
                <div class="art-card">
                    ...
                    <ArtLineChart :data="multiLineData" :showLegend="true" :xAxisData="['1月', '2月', '3月', '4月', '5月', '6月']" />
                </div>
            </ElCol>
            ...
            <ElCol :lg="8" :md="12" :xs="24" class="mb-5">
                <div class="art-card">
                    ...
                    <ArtHBarChart :data="[50, 80, 120, 90, 60]" :xAxisData="['产品A', '产品B', '产品C', '产品D', '产品E']" />
                </div>
            </ElCol>
            <ElCol :lg="8" :md="12" :xs="24" class="mb-5">
                <div class="art-card">
