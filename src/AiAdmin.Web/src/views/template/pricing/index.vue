    ...
    <div class="pt-24 px-20 max-md:!pt-15 max-sm:!px-5 max-md:!px-8 bg-transparent !border-none">
        <div class="mb-10 text-center">
            ...
            <div class="gap-2 flex-cc mt-2.5 max-sm:mt-3.5 max-sm:!block">
                <p class="text-sm italic text-g-600 max-sm:text-sm">本项目基于 MIT 协议开源免费，当前页面为定价模板，仅作演示用途</p>
                <ElTag class="max-sm:mt-3.5" round size="large" type="success">免费商用</ElTag>
            </div>
        </div>

        <div class="mt-20 max-md:mt-0">
            <ElRow :gutter="20" justify="center">
                <ElCol v-for="plan in pricingPlans" :key="plan.type" :md="6" :sm="12" :xs="24" class="mb-5">
                    <ElCard class="flex flex-col h-full rounded-xl">
                        <div class="mb-5">
                            <h3 class="mb-2.5 text-xl font-medium">{{ plan.title }}</h3>
                            <p class="h-10 pb-5 mb-5 overflow-hidden text-sm text-g-600 text-ellipsis border-b border-g-300/80 line-clamp-2">
                                {{ plan.description }}
                            </p>
                            <div class="mt-7.5">
                        ...
                        <div class="flex-grow mb-5">
                            <div v-for="(feature, index) in plan.features" :key="index" class="flex-c mb-2.5 text-sm">
                                <ElIcon :class="feature.available ? '!text-theme' : '!text-danger'" class="mr-2.5">
                        ...
                        <div class="mt-auto text-center">
                            <ElButton v-ripple class="w-full h-10" type="primary">立即购买</ElButton>
                        </div>
                    </ElCard>
                </ElCol>
            </ElRow>
