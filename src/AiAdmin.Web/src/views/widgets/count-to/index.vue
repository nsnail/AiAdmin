<template>
    <div class="page-content mb-5">
        <div class="mb-15 text-center">
            <h1 class="my-4 text-2xl font-semibold leading-tight">基于 VueUse useTransition 的 Count-To 组件</h1>
            <p class="m-0 text-base leading-relaxed text-g-700">高性能数字滚动动画组件，支持完整的动画控制和事件监听</p>
        </div>
        ...
        <div class="mb-15">
            ...
            <div class="count">
                <ArtCountTo :duration="2000" :target="1000" />
            </div>
        </div>
        ...
        <div class="mb-15">
            ...
            <div class="count">
                <ArtCountTo :decimals="2" :duration="2500" :target="20000" prefix="¥" suffix="元" />
            </div>
        </div>
        ...
        <div class="mb-15">
            ...
            <div class="count">
                <ArtCountTo :decimals="2" :duration="3000" :target="2023.45" separator="," />
            </div>
        </div>
        ...
        <div class="mb-15">
            ...
            <div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 mb-8">
                <div v-for="easing in easingTypes" :key="easing.type" class="text-center">
                    ...
                    <div class="count">
                        <ArtCountTo :duration="3000" :easing="easing.type" :target="easingTarget" />
                    </div>
                </div>
            </div>
