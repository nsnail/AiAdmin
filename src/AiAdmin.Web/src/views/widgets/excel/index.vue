<template>
    <div class="page-content">
        <ArtExcelImport @import-error="handleImportError" @import-success="handleImportSuccess">
        ...
        <ElButton v-ripple @click="handleClear" type="danger">清除数据</ElButton>

        <ArtTable :data="tableData" style="margin-top: 10px">
            <ElTableColumn v-for="key in Object.keys(headers)" :key="key" :label="headers[key as keyof typeof headers]" :prop="key" />
        </ArtTable>
    </div>
</template>
