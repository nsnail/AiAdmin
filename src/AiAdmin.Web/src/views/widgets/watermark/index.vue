<template>
    <div class="page-content mb-5">
        ...
        <ElCard class="mb-7.5">
            ...
            <ElWatermark :font="{ color: 'rgba(128, 128, 128, 0.2)' }" content="Art Design Pro">
        ...
        <ElCard class="mb-7.5">
            ...
            <ElWatermark :content="['Art Design Pro', '专注用户体验，视觉设计']" :font="{ fontSize: 16, color: 'rgba(128, 128, 128, 0.2)' }">
                <div style="height: 200px"></div>
            </ElWatermark>
        </ElCard>
        ...
        <ElCard class="mb-7.5">
            ...
            <ElWatermark :height="20" :image="watermarkImage" :opacity="0.2" :width="80">
                <div style="height: 200px"></div>
            </ElWatermark>
        </ElCard>
        ...
        <ElButton :type="settingStore.watermarkVisible ? 'danger' : 'primary'" @click="handleWatermarkVisible">
